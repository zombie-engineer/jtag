...
cmdtm_resp_types = {
  sdhc.RESP_TYPE_R1  : RESP_TYPE_48_BITS,
  sdhc.RESP_TYPE_R1b : RESP_TYPE_48_BITS_BUSY,
  sdhc.RESP_TYPE_R2  : RESP_TYPE_136_BITS,
  sdhc.RESP_TYPE_R3  : RESP_TYPE_48_BITS,
  sdhc.RESP_TYPE_R6  : RESP_TYPE_48_BITS,
  sdhc.RESP_TYPE_R7  : RESP_TYPE_48_BITS,
  sdhc.RESP_TYPE_NA  : RESP_TYPE_NONE
}
